    ...
    <div className="min-h-screen flex flex-col bg-[#fbfcfd] font-sans text-slate-900 relative">
      ...
      <main className="relative z-10 flex-1">
        {/* ==========================================================================
           ...
           ========================================================================== */}
        <section className="relative py-8 sm:py-12 lg:py-16 border-b border-slate-200/90 overflow-hidden">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-5 sm:space-y-6">
                {/* Pill Badge */}
                <div className="inline-flex items-center gap-1.5 sm:gap-2 px-3 py-1.5 rounded-full bg-[#fdf8ee] border border-[#f5deae] text-[#85530f] text-[10px] sm:text-xs font-bold tracking-wide shadow-2xs max-w-full">
                  <Shield className="w-3.5 h-3.5 text-amber-600 flex-shrink-0" />
                  <span className="truncate">INDIA ISLAMIC CULTURAL CENTRE (IICC) • SESSION 2026–27</span>
                </div>

                {/* Main Heading with Serif Font and Golden Accent Underline */}
                <div className="relative">
                  <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[3.25rem] font-serif font-bold text-slate-950 tracking-tight leading-[1.2] sm:leading-[1.15]">
                    IICC Merit-cum-Means{" "}
                    <span className="relative inline-block mt-1 sm:mt-0">
                      Scholarship Programme
                      <span className="absolute -bottom-1 left-0 w-32 sm:w-56 h-1 sm:h-1.5 bg-amber-400/90 rounded-full" />
                    </span>
                  </h1>
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-1 sm:pt-2">
                  <Link
                    href="/eligibility"
                    className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-[#0f2544] hover:bg-[#1a3964] text-white font-bold text-xs sm:text-sm shadow-sm hover:shadow transition active:scale-98 tracking-wide cursor-pointer w-full sm:w-auto text-center"
                  >
                  ...
                  <Link
                    href="/scholarships"
                    className="inline-flex items-center justify-center gap-2 px-5 py-3.5 rounded-xl bg-white hover:bg-slate-50 text-slate-800 border border-slate-300 font-semibold text-xs sm:text-sm shadow-2xs hover:shadow-xs transition w-full sm:w-auto text-center"
                  >
                ...
                <div className="pt-4 sm:pt-6 border-t border-slate-200/90 grid grid-cols-1 sm:grid-cols-3 gap-2.5 sm:gap-4">
                  <div className="flex items-center gap-3 p-2.5 sm:p-0 bg-slate-50/80 sm:bg-transparent rounded-xl sm:rounded-none border border-slate-200/60 sm:border-0">
              ...
              <div className="lg:col-span-5">
                <div className="relative mx-auto max-w-md lg:max-w-none">
                  ...
                  <div className="relative rounded-2xl sm:rounded-3xl p-2 sm:p-3 bg-white border-2 border-amber-300/80 shadow-lg sm:shadow-xl overflow-hidden">
                    ...
                    <div className="mt-2.5 sm:mt-3 bg-white rounded-xl sm:rounded-2xl border border-slate-200/90 p-3 sm:p-4 shadow-sm flex items-center justify-between gap-2">
                      <div className="flex items-center gap-2.5 sm:gap-3">
                        <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-amber-100 border border-amber-300 flex items-center justify-center text-amber-700 flex-shrink-0">
                          <Award className="w-4 h-4 sm:w-5 sm:h-5 text-amber-600" />
                        </div>
                        <div>
                          <span className="text-[9px] sm:text-[10px] text-slate-500 font-bold uppercase tracking-wider block leading-tight">
                            Max Statutory Grant
                          </span>
                          <span className="text-lg sm:text-xl font-black text-emerald-600 font-mono tracking-tight leading-none block mt-0.5">
                            ₹60,000 <span className="text-[11px] sm:text-xs font-medium text-slate-500">/ Year</span>
                          </span>
                        </div>
                      </div>
                      <span className="px-2.5 py-1 sm:px-3 rounded-full bg-slate-100 text-slate-700 border border-slate-200 text-[11px] sm:text-xs font-bold whitespace-nowrap">
                        200 Scholars
                      </span>
                    </div>
                  </div>
                  ...
                  {/* Address sub-caption */}
                  <div className="flex items-center justify-center gap-1 text-[10px] sm:text-[11px] text-slate-500 font-medium mt-2.5 sm:mt-3 text-center px-2">
                    <MapPin className="w-3.5 h-3.5 text-amber-600 flex-shrink-0" />
                    <span className="truncate">87–88, Lodhi Road, New Delhi – 110003 • Statutory Secretariat</span>
                  </div>
                </div>
              </div>
        ...
        {/* ==========================================================================
           ...
           ========================================================================== */}
        <section className="relative py-6 sm:py-8 bg-white border-b border-slate-200/90">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 md:gap-0 md:divide-x md:divide-slate-200/90">
              
              {/* Stat 1 */}
              <div className="p-3.5 sm:p-4 bg-[#f8fafc] md:bg-transparent rounded-xl md:rounded-none border border-slate-200/80 md:border-0 text-left">
                <span className="text-[10px] sm:text-[11px] font-bold text-slate-500 uppercase tracking-wider block mb-0.5 sm:mb-1">
                  Total Scholarships
                </span>
                <div className="text-xl sm:text-2xl lg:text-3xl font-black text-slate-950 font-mono leading-tight">
                  200 <span className="text-xs sm:text-sm font-normal text-slate-600">Seats</span>
                </div>
                <span className="text-[11px] sm:text-xs text-slate-500 mt-0.5 sm:mt-1 block truncate">
              ...
              <div className="p-3.5 sm:p-4 bg-[#f8fafc] md:bg-transparent rounded-xl md:rounded-none border border-slate-200/80 md:border-0 text-left">
                ...
                <div className="text-xl sm:text-2xl lg:text-3xl font-black text-red-600 font-mono leading-tight">
                  31 Oct 2026
                </div>
                <span className="text-[11px] sm:text-xs text-slate-500 mt-0.5 sm:mt-1 flex items-center gap-1.5 truncate">
                  <span className="w-1.5 h-1.5 rounded-full bg-red-500 animate-pulse flex-shrink-0" />
                  Portal closes 23:59 IST
                </span>
              </div>
        ...
        {/* ==========================================================================
           ...
           ========================================================================== */}
        <section className="relative py-8 sm:py-14 bg-[#fbfcfd] border-b border-slate-200/90">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="p-4 sm:p-6 lg:p-8">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 pb-4 sm:pb-6 border-b border-slate-100">
                  <div className="flex items-start gap-3">
                    <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-blue-50 border border-blue-200/80 flex items-center justify-center text-[#0f2544] flex-shrink-0 mt-0.5">
                      <ShieldCheck className="w-4 h-4 sm:w-5 sm:h-5 text-blue-800" />
                    </div>
                    <div>
                  ...
                  <span className="self-start sm:self-auto px-2.5 py-1 sm:px-3 rounded-full bg-blue-50 text-blue-900 border border-blue-200/80 text-[10px] sm:text-xs font-bold tracking-wide uppercase">
                    Statutory Criteria 2026–27
                  </span>
                </div>

                {/* 3 Condition Cards Grid */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5 sm:gap-6 pt-4 sm:pt-6">
                  {/* Condition 1 */}
                  <div className="bg-[#f8fafc] rounded-xl border border-slate-200/90 p-4 sm:p-5 flex flex-col justify-between hover:border-slate-300 transition shadow-2xs">
                    <div>
                      <div className="flex items-center justify-between mb-3 sm:mb-4">
                        <div className="w-6 h-6 rounded-full bg-emerald-100 flex items-center justify-center text-emerald-700">
                          <Check className="w-3.5 h-3.5 stroke-[2.5]" />
                        </div>
                        <span className="font-mono text-[10px] sm:text-[11px] font-bold text-slate-400">
                          RULE § 2.1
                        </span>
                      </div>

                      <h3 className="text-sm font-bold text-slate-950 mb-1.5 sm:mb-2">
                    ...
                    <div className="pt-3 border-t border-slate-200/70 flex items-center gap-1.5 text-[10px] sm:text-[11px] font-medium text-amber-900">
                      <FileText className="w-3.5 h-3.5 text-amber-600 flex-shrink-0" />
                      <span className="truncate">Valid Aadhaar / Passport / Voter Card</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#f8fafc] rounded-xl border border-slate-200/90 p-4 sm:p-5 flex flex-col justify-between hover:border-slate-300 transition shadow-2xs">
                    ...
                    <div className="pt-3 border-t border-slate-200/70 flex items-center gap-1.5 text-[10px] sm:text-[11px] font-medium text-amber-900">
                      ...
                      <span className="truncate">Full-Time Regular Enrolment Certificate</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#f8fafc] rounded-xl border border-slate-200/90 p-4 sm:p-5 flex flex-col justify-between hover:border-slate-300 transition shadow-2xs">
                    ...
                    <div className="pt-3 border-t border-slate-200/70 flex items-center gap-1.5 text-[10px] sm:text-[11px] font-medium text-amber-900">
                      <FileText className="w-3.5 h-3.5 text-amber-600 flex-shrink-0" />
                      <span className="truncate">Official Marksheet Attestation</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        {/* ==========================================================================
           ...
           ========================================================================== */}
        <section className="relative py-6 sm:py-8 bg-[#fbfcfd]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-[#0c1e36] text-white rounded-2xl p-5 sm:p-7 flex flex-col md:flex-row items-stretch md:items-center justify-between gap-5 shadow-md border border-[#142d50]">
              <div className="flex items-start gap-3.5 sm:gap-4">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-amber-400/20 border border-amber-400/30 flex items-center justify-center text-amber-400 flex-shrink-0 mt-0.5">
              ...
              <Link
                href="/eligibility"
                className="w-full md:w-auto inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-[#fef3c7] hover:bg-[#fde68a] text-slate-950 font-bold text-xs sm:text-sm transition shadow-sm active:scale-98 flex-shrink-0 cursor-pointer text-center"
              >
        ...
        {/* ==========================================================================
           ...
           ========================================================================== */}
        <section className="relative py-10 sm:py-14 bg-white border-b border-slate-200/90">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            {/* Header with Filter Dropdown */}
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-8 sm:mb-10">
              <div>
                <span className="text-[10px] sm:text-[11px] font-bold text-amber-900 tracking-widest uppercase block mb-1">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-1.5 sm:gap-2 w-full sm:w-auto">
                ...
                <div className="relative w-full sm:w-auto">
                  <select
                    ...
                    className="w-full sm:w-auto appearance-none bg-white border border-slate-300 text-slate-800 text-xs font-medium rounded-lg px-3.5 py-2 pr-8 shadow-2xs hover:border-slate-400 focus:outline-none focus:ring-2 focus:ring-navy-900 cursor-pointer"
                  >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {filteredScholarships.map((sch) => (
                <div
                  key={sch.id}
                  className="bg-white rounded-2xl border border-slate-200/90 p-5 sm:p-6 shadow-sm hover:shadow-md transition flex flex-col justify-between gap-4 sm:gap-5"
                >
                  <div className="space-y-3.5 sm:space-y-4">
                    {/* Category & Deadline Badges */}
                    <div className="flex items-center justify-between gap-2 flex-wrap">
                      <span className="px-2.5 py-0.5 sm:py-1 rounded-md bg-blue-50 text-blue-900 border border-blue-200/80 font-bold text-[10px] tracking-wide uppercase">
                        {sch.category}
                      </span>
                      <span className="px-2.5 py-0.5 sm:py-1 rounded-md bg-rose-50 text-rose-800 border border-rose-200/80 font-semibold text-[10px] flex items-center gap-1">
                    ...
                    <div className="bg-[#f8fafc] rounded-xl p-3 sm:p-3.5 border border-slate-200/80 text-xs">
                  ...
                  <div className="pt-3.5 sm:pt-4 border-t border-slate-100 space-y-3.5 sm:space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="px-2.5 py-0.5 sm:px-3 sm:py-1 rounded-full bg-amber-100/80 text-amber-900 border border-amber-300/70 text-xs font-bold">
        ...
        {/* ==========================================================================
           ...
           ========================================================================== */}
        <section id="how-it-works" className="relative py-12 sm:py-16 bg-[#fbfcfd] border-b border-slate-200/90">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              <div className="relative bg-white rounded-xl border border-slate-200/90 p-5 sm:p-6 shadow-xs hover:border-slate-300 transition">
                <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-lg bg-[#0f2544] text-white font-bold text-xs sm:text-sm flex items-center justify-center mb-3 shadow-2xs">
                  1
                </div>
                <h3 className="text-sm font-bold text-slate-900 mb-1">Check Eligibility</h3>
              ...
              <div className="relative bg-white rounded-xl border border-slate-200/90 p-5 sm:p-6 shadow-xs hover:border-slate-300 transition">
                ...
                <h3 className="text-sm font-bold text-slate-900 mb-1">Submit Application</h3>
                <p className="text-xs text-slate-600 leading-relaxed">
              ...
              <div className="relative bg-white rounded-xl border border-slate-200/90 p-5 sm:p-6 shadow-xs hover:border-slate-300 transition">
                ...
                <h3 className="text-sm font-bold text-slate-900 mb-1">Merit Shortlisting</h3>
                <p className="text-xs text-slate-600 leading-relaxed">
              ...
              <div className="relative bg-white rounded-xl border border-slate-200/90 p-5 sm:p-6 shadow-xs hover:border-slate-300 transition">
                <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-lg bg-emerald-700 text-white font-bold text-xs sm:text-sm flex items-center justify-center mb-3 shadow-2xs">
                  4
                </div>
                <h3 className="text-sm font-bold text-slate-900 mb-1">Final Award &amp; DBT</h3>
                <p className="text-xs text-slate-600 leading-relaxed">
        ...
        {/* ==========================================================================
           ...
           ========================================================================== */}
        <section className="relative py-10 sm:py-18 bg-[#fbfcfd]">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="relative bg-[#0d1e35] text-white rounded-2xl sm:rounded-3xl p-6 sm:p-10 lg:p-14 overflow-hidden shadow-xl border border-slate-800">
              {/* Subtle Mortarboard Watermark in background */}
              <GraduationCap
                className="hidden sm:block absolute -right-8 -bottom-10 w-60 h-60 lg:w-72 lg:h-72 text-slate-700/20 pointer-events-none select-none"
                strokeWidth={1}
              />

              <div className="relative z-10 max-w-2xl space-y-3.5 sm:space-y-4">
                {/* Applications Live Pill */}
                <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-400/20 text-amber-300 border border-amber-400/30 text-[10px] sm:text-xs font-semibold uppercase tracking-wider">
                  <Zap className="w-3.5 h-3.5 text-amber-400 flex-shrink-0" />
                  <span className="truncate">Applications Live For Academic Year 2026–27</span>
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-2 sm:pt-4">
                  <Link
                    href="/eligibility"
                    className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-[#f59e0b] hover:bg-[#d97706] text-slate-950 font-bold text-xs sm:text-sm shadow-md transition active:scale-98 cursor-pointer w-full sm:w-auto text-center"
                  >
                  ...
                  <Link
                    ...
                    className="inline-flex items-center justify-center px-6 py-3.5 rounded-xl bg-white/10 hover:bg-white/15 text-white border border-white/20 font-semibold text-xs sm:text-sm transition cursor-pointer w-full sm:w-auto text-center"
                  >
